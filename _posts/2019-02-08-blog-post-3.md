...
1. Why the directories of this application expose the framework? Do I need to know the framework?!

2.  Or why doesn’t the high-level directory of this application tell me what the application actually does?

### Why the framework in front of me is hiding what is the application supposed to do?!
